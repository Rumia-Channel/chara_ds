...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Shortcut for OpenCode Go remote API. "
            f"Defaults to --base-url {OPENCODE_GO_DEFAULT_BASE_URL}, "
            f"--model {OPENCODE_GO_DEFAULT_MODEL}, --thinking off, and omits max_tokens. "
            "Set OPENCODE_GO_API_KEY environment variable."
        ),
    )
    parser.add_argument(
        "--sakura",
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Provider for persona controller generation. "
